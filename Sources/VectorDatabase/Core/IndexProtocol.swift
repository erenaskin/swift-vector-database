...
// and HNSWIndex conform to. VectorDatabase (the public actor) holds either
...
//
// ┌─────────────────────────────────────────────────────────────┐
// │  Public API (actor VectorDatabase)                                 │
...
///
/// `VectorDatabase` (the public actor) holds an existential or generic reference to
...
///   `[Float]` so that the call site in `VectorDatabase` copies the caller's array
